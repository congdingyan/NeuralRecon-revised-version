...
def parse_args():
    ...
    parser.add_argument("--data_path", metavar="DIR",
                        help="path to dataset", default='/home/cdy/桌面/NeuralRecon-master/data/data4/scans_test')
...
def main():
    ...
    for dirworks in info_files:
        results=process_with_single_worker(dirworks)
