...
class NeuralRecon(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # networks
        self.backbone2d = MnasMulti(alpha)  #MnasNet网络，用于提取2维图片特征
        self.neucon_net = NeuConNet(cfg.MODEL) # 论文网络的主体部分
        # for fusing to global volume
        self.fuse_to_global = GRUFusion(cfg.MODEL, direct_substitute=True) #最后一步的融合
